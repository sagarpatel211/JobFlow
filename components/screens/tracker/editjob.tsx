...
import { EditJobRowProps } from "@/types/job";
import { statuses, statusColors } from "@/lib/constants";

export function EditJobRow({ job, onUpdateJob, onSaveJob, onCancelEditJob, updateStatus }: EditJobRowProps) {
