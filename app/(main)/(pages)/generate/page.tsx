...
const ResumeBuilder = () => {
  ...
  return (
    ...
    >
      ...
      <DragOverlay>
        {activeId && getItemById(activeId) ? <ItemOverlay item={getItemById(activeId)!} /> : null}
      </DragOverlay>
    </DndContext>
  );
};
  ...
  return (
    <div className="flex flex-col gap-4 relative">
      ...
      <div className="flex gap-8 items-center p-6">
        ...
        <div className="flex items-center gap-2">
          <Checkbox checked={resumeEnabled} onCheckedChange={(checked) => setResumeEnabled(!!checked)} />
          <Label>Resume</Label>
        </div>
      </div>
